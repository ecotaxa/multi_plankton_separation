...
pipeline {
    ...
    environment {
        author_name = "Emma Amblard"
        author_email = "emma.amblard@imev-mer.fr"
        app_name = "multi_plankton_separation"
        job_location = "Pipeline-as-code/DEEP-OC-org/UC-emmaamblard-DEEP-OC-multi_plankton_separation/${env.BRANCH_NAME}"
    }
